...
def build_unit_page(unit: str) -> bool:
    ...
    for idx, essay in enumerate(essays):
        ...
        if page_html != existing:
            ...
            essay_count += 1
            print(f"  unit {unit}: wrote {essay['html']}")

    if not unit_changed and essay_count == 0:
